 ...
 public class VisionCameraCodeScannerPlugin extends FrameProcessorPlugin {
   public VisionCameraCodeScannerPlugin(VisionCameraProxy visionCameraProxy, Map<String, Object> stringObjectMap) {
   ...
   public Object callback(@NonNull Frame frame, @Nullable Map<String, Object> params) throws Throwable {
     ...
     if (mediaImage != null) {
       ...
       InputImage image = InputImage.fromMediaImage(mediaImage, frame.getImageProxy().getImageInfo().getRotationDegrees());
